					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Northwind OData Master Detail",
									"targetURL": "#nsnorthwind-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"nsnorthwind-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.northwind",
									"url": sap.ui.require.toUrl("ns/northwind")
								}
							}
						}
					}
